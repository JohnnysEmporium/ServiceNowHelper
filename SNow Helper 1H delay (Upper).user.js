// ==UserScript==
// @name         SNow Helper 1H delay (Upper)
// @author       Jan Sobczak
...
function RUNALL(){
    ...
    if(document.readyState === 'complete'){
        ...
        //SNOW MAIN/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        if (snMain !== null){
            var ad = new Audio('http://www.noiseaddicts.com/samples_1w72b820/2535.mp3');
            console.log('SNS');
            ...
            function action(){
                if (anchor() > 5){
                    console.log("ANCHOR:FALSE ANCHOR:FALSE ANCHOR:FALSE ANCHOR:FALSE ANCHOR:FALSE")
...
//                     }, 60000);
            ...
            setInterval(function(){
                ...
                if(!doNotRefresh){
                    console.log('REFRESHING REFRESHING REFRESHING REFRESHING REFRESHING')
                    rfsh();
                    setTimeout(function(){
                        action();
                    }, 10000);
